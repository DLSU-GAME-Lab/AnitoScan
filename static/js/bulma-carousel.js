        ...
        /******/ [
            ...
            /***/ function (module, __webpack_exports__, __webpack_require__) {
                ...
                var isNode = function isNode(unknown) {
                    return !!(
                        unknown &&
                        (unknown.nodeType === HTMLElement) | SVGElement
                    );
                };
                ...
                var isVimeo = function isVimeo(unknown) {
                    return (
                        isIFrame(unknown) &&
                        !!unknown.src.match(/vimeo\.com\/video\/.*/)
                    );
                };
                    ...
                    _createClass(Coordinate, [
                        ...
                        },
                        {
                            ...
                            value: function equals(coord) {
                                ...
                                return (
                                    this._x == coord._x && this._y == coord._y
                                );
                            },
                        },
                        {
                ...
                var bulmaCarousel = (function (_EventEmitter) {
                    ...
                    function bulmaCarousel(selector) {
                        ...
                        var _this = _possibleConstructorReturn(
                            this,
                            (
                                bulmaCarousel.__proto__ ||
                                Object.getPrototypeOf(bulmaCarousel)
                            ).call(this),
                        );
                        ...
                        [
                            ...
                            },
                            {
                                ...
                                value: function _build() {
                                    ...
                                    this._slides = this._items.map(
                                        function (item, index) {
                                            return _this2._createSlide(
                                                item,
                                                index,
                                            );
                                        },
                                    ...
                                    this._ui.wrapper.classList.remove(
                                        "is-loading",
                                    );
                                },
                            ...
                            },
                            {
                                ...
                                value: function _setClasses() {
                                    ...
                                    this._slides.forEach(function (slide) {
                                        ...
                                        if (
                                            Math.abs(
                                                (_this4.state.index - 1) %
                                                    _this4.state.length,
                                            ) ===
                                            parseInt(
                                                slide.dataset.sliderIndex,
                                                10,
                                            )
                                        ) {
                                            slide.classList.add(
                            ...
                            },
                            {
                                ...
                                value: function reset() {
                                    ...
                                    this._slides.forEach(function (slide) {
                                        return _this5._ui.container.appendChild(
                                            slide,
                                        );
                                    });
                                    this._transitioner
                            ...
                            },
                            {
                                key: "direction",
                                get: function get() {
                                    return this.element.dir.toLowerCase() ===
                                        "rtl" ||
                    ...
                    __WEBPACK_IMPORTED_MODULE_3__utils_eventEmitter__[
                        "a" /* default */
                    ],
                );
                ...
                var Autoplay = (function (_EventEmitter) {
                    ...
                    function Autoplay(slider) {
                        ...
                        var _this = _possibleConstructorReturn(
                            ...
                            (
                                Autoplay.__proto__ ||
                                Object.getPrototypeOf(Autoplay)
                            ).call(this),
                        );
                        ...
                        _this.onVisibilityChange =
                            _this.onVisibilityChange.bind(_this);
                            ...
                            value: function start() {
                                ...
                                if (this.slider.options.autoplay) {
                                    ...
                                    this._interval = setInterval(function () {
                                        if (!(
                                            _this2._hovering &&
                                            _this2.slider.options.pauseOnHover
                                        )) {
                                            if (
                                                !_this2.slider.options
                                                    .centerMode &&
                    ...
                    __WEBPACK_IMPORTED_MODULE_0__utils_eventEmitter__[
                        "a" /* default */
                    ],
                );
            ...
            /***/ function (module, __webpack_exports__, __webpack_require__) {
                ...
                var isiPod = navigator.userAgent.match(
                    /(iPod)(.*OS\s([\d_]+))?/,
                );
                var isiPhone =
                    ...
                    _createClass(Breakpoints, [
                        {
                            ...
                            value: function init() {
                                ...
                                this.options.breakpoints.sort(function (a, b) {
                                    return (
                                        parseInt(a.changePoint, 10) >
                                        parseInt(b.changePoint, 10)
                                    );
                                });
                                this._currentBreakpoint =
                                    this._getActiveBreakpoint();
                    ...
                    _createClass(Navigation, [
                        ...
                        },
                        {
                            ...
                            value: function _bindEvents() {
                                ...
                                this.slider.wrapper.addEventListener(
                                    "keyup",
                                    this.onKeyUp,
                                );
                                this._clickEvents.forEach(
                                    function (clickEvent) {
                            ...
                            value: function refresh() {
                                ...
                                if (
                                    ...
                                    if (
                                        ...
                                        this._ui.previous.classList.remove(
                                            "is-hidden",
                                        );
                                        this._ui.next.classList.remove(
                                            "is-hidden",
                                        );
                                        if (this.slider.state.next === 0) {
                                            this._ui.previous.classList.add(
                                                "is-hidden",
                                            );
                                            this._ui.next.classList.remove(
                                                "is-hidden",
                            ...
                            value: function _draw() {
                                ...
                                if (
                                    ...
                                    for (var i = 0; i <= this._count; i++) {
                                        ...
                                        newPageNode.dataset.index =
                                            i * this.slider.slidesToScroll;
                            ...
                            value: function refresh() {
                                ...
                                this._pages.forEach(function (page) {
                                    ...
                                    if (
                                        ...
                                        _this3.slider.state.next %
                                            _this3.slider.state.length
                                    ) {
            ...
            /***/ function (module, __webpack_exports__, __webpack_require__) {
                ...
                var Transitioner = (function () {
                    function Transitioner(slider) {
                        ...
                        this._fade =
                            new __WEBPACK_IMPORTED_MODULE_0__transitions_fade__[
                                "a" /* default */
                            ](this, slider, slider.options);
                    }
                    ...
                    _createClass(Fade, [
                                ...
                                if (this.options.effect === "fade") {
                                    this.slider.slides.forEach(
                                        function (slide, index) {
                                            Object(
                                                __WEBPACK_IMPORTED_MODULE_0__utils_css__[
                                                    "a" /* css */
                                                ],
                                            )(slide, {
                                                position: "absolute",
                        ...
                        },
                        {
                            ...
                            value: function enable() {
                                ...
                                this._oldSlide = this.slider.slides.filter(
                                    function (slide) {
                                        return (
                                            slide.dataset.sliderIndex ==
                                            _this2.slider.state.index
                                        );
                                    },
                                )[0];
                                this._newSlide = this.slider.slides.filter(
                                    function (slide) {
                                        return (
                                            slide.dataset.sliderIndex ==
                                            _this2.slider.state.next
                    ...
                    _createClass(Translate, [
                        ...
                        },
                        {
                            ...
                            value: function apply() {
                                ...
                                if (this.options.effect === "translate") {
                                    var slide = this.slider.slides.filter(
                                        function (slide) {
                                            return (
                                                slide.dataset.sliderIndex ==
                                                _this.slider.state.next
                                            );
                                        },
                                    )[0];
                                    var slideOffset =
                            ...
                            value: function onTransitionEnd(e) {
                                if (this.options.effect === "translate") {
                                    if (
                                        ...
                                        if (this.options.infinite) {
                                            this.slider._infinite.onTransitionEnd(
                                                e,
                                            );
                                        }
                                    }
