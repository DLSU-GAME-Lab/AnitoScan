!(function (t, e) {
    ...
    return (function (i) {
        ...
        function (t, e, i) {
            ...
            var n = i(2),
                s = function (e, t) {
                    (t = Array.isArray(t) ? t : t.split(" ")).forEach(
                        function (t) {
                ...
                return (
                    n(s, [
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                return new s(
                                    Math.max(this._x, t._x),
                                    Math.max(this._y, t._y),
                                );
                            },
                        },
                        {
                                    ...
                                    (this.options.vertical
                                        ...
                                        : this.options.centerMode &&
                                          (this._ui.wrapper.style.padding =
                                              "0px " +
                                              this.options.centerPadding),
                                        (this._wrapperWidth = Object(s.e)(
                                            this._ui.wrapper,
                                        )),
                                        (this._wrapperHeight = Object(s.c)(
                                            this._ui.wrapper,
                                        )),
                                        this.options.vertical
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    ((this.state = {
                                        ...
                                        this._slides.forEach(function (t) {
                                            return e._ui.container.appendChild(
                                                t,
                                            );
                                        }),
                                        this._transitioner
                            ...
                            value: function () {
                                ...
                                (this.slider.wrapper.addEventListener(
                                    ...
                                    this._clickEvents.forEach(function (t) {
                                        (e._ui.previous.addEventListener(
                                            t,
                                            e.onPreviousClick,
                                        ),
                                            e._ui.next.addEventListener(
                                                t,
                                                e.onNextClick,
                                            ));
                                    }));
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                (this.slider.wrapper.removeEventListener(
                                    ...
                                    this._clickEvents.forEach(function (t) {
                                        (e._ui.previous.removeEventListener(
                                            t,
                                            e.onPreviousClick,
                                        ),
                                            e._ui.next.removeEventListener(
                                                t,
                                                e.onNextClick,
                                            ));
                                    }));
                                    ...
                                    ((this._lastTranslate = new n.a(
                                        ...
                                        t.touches &&
                                            Math.abs(this._lastTranslate.x) >
                                                Math.abs(
                                                    this._lastTranslate.y,
                                                ) &&
                                            (this._supportsPassive ||
                                                t.preventDefault(),
                                            t.stopPropagation()));
                                }
                            },
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                if ("translate" === this.options.effect) {
                                    var i = this.slider.slides.filter(
                                            function (t) {
                                                return (
                                                    t.dataset.sliderIndex ==
                                                    e.slider.state.next
                                    ...
                                    var s = new r.a(
                                        Math.min(
                                            Math.max(-1 * n.x, -1 * t.x),
                                            0,
                                        ),
                                        Math.min(
                                            Math.max(-1 * n.y, -1 * t.y),
                                            0,
                                        ),
                                    );
                                    (this.options.loop &&
                                        (!this.options.vertical &&
                                        Math.abs(this._position.x) > t.x
                                            ? ((s.x = 0),
                                              (this.slider.state.next = 0))
                                            : this.options.vertical &&
