                ...
                var bulmaSlider = (function (_EventEmitter) {
                    ...
                    function bulmaSlider(selector) {
                        ...
                        var _this = _possibleConstructorReturn(
                            this,
                            (
                                bulmaSlider.__proto__ ||
                                Object.getPrototypeOf(bulmaSlider)
                            ).call(this),
                        );
                        ...
                        [
                            ...
                            },
                            {
                                ...
                                value: function _findOutputForSlider() {
                                    ...
                                    Array.from(outputs).forEach(
                                        function (output) {
                                            if (
                                                output.htmlFor ==
                                                _this2.element.getAttribute(
                                                    "id",
                                                )
                                            ) {
                                                result = output;
                            ...
                            },
                            {
                                ...
                                value: function onSliderInput(e) {
                                    ...
                                    var prefix = this.output.hasAttribute(
                                        "data-prefix",
                                    )
                                        ? this.output.getAttribute(
                                              "data-prefix",
                                          )
                                        : "";
                                    var postfix = this.output.hasAttribute(
                                        "data-postfix",
                                    )
                                        ? this.output.getAttribute(
                                              "data-postfix",
                                    ...
                                    this.output.value =
                                        prefix + this.element.value + postfix;
                        ...
                        [
                            {
                                ...
                                value: function attach() {
                                    ...
                                    elements.forEach(function (element) {
                                        if (
                                            typeof element[
                                                _this3.constructor.name
                                            ] === "undefined"
                                        ) {
                                            var instance = new bulmaSlider(
                                                element,
                                                options,
                                            );
                                            element[_this3.constructor.name] =
                                                instance;
                        ...
                        },
                        {
                            ...
                            value: function middleware(eventName, fn) {
                                ...
                                if (Array.isArray(eventName)) {
                                    ...
                                    if (
                                        !Array.isArray(
                                            this._middlewares.get(eventName),
                                        )
                                    ) {
